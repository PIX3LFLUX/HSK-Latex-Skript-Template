...
These parameters define the layout for the presentation.

For font size:

\begin{itemize}
    \item \verb!\covertextsize!
    \item \verb!\titletextsize!
    \item \verb!\contenttextsize!
\end{itemize}

For object placement, please refer the below list and the image:
...
\begin{itemize}
  ...
  \item \verb!\secondcolumnstart!: X value from the origin to second column. Please refer to the demo. 
\end{itemize}
...
Positioning in beamer is done based on \textbf{tikz} library and some of \textbf{beamer} library. There are some helper functions created to quickly construct a simple presentation, including its argument descriptions.
