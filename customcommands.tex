...
\newcommand{\createTikZTitlePage}[3]{
	...
	%%% Background Picture %%%
		...
		{\includegraphics[height=14.82cm]{../Pictures/iStock/HKA_EIT_Digitaltechnik_4.jpg}}; 
	...
	%%% Text Blocks %%%
		...
		\node[text width = 10cm, ThemeColor, below right] at (UoAS) {\textbf{Hochschule Karlsruhe}\\University of\\Applied Sciences};
		% Faculty
		\node[text width = 10cm, ThemeColor, below right] at (Faculty) {Fakultät für\\ \textbf{#1}};
		% Title and Subtitle 
	...
	%%% +| KA %%%
		...
		\path (H) [fill=ThemeColor, scale = 0.45, rounded corners = 3] +(0,-2.95)  -- +(3,-2.95) -- +(3,0) -- +(4.2,0)  -- +(4.2,-2.95) -- +(7.2,-2.95) -- +(7.2,-3.95) -- +(4.2,-3.95) -- +(4.2,-6.9) -- +(3,-6.9) -- +(3,-3.95) -- +(0,-3.95) -- cycle;
		\path (H) [fill=ThemeColor, scale = 0.45, rounded corners = 3] +(7.8,0)  -- +(9,0) -- +(9,-6.9) -- +(7.8,-6.9) -- cycle;
		\path (K) [fill=ThemeColor, scale = 0.45, rounded corners = 3] +(3, 0) -- +(4.2,0) -- +(4.2,-2.8) -- +(9,0) -- +(9,-1.3) -- +(5.2,-3.45) -- +(9,-5.6) -- +(9,-6.9) -- +(4.2,-4.1) -- +(4.2,-6.9) -- +(3,-6.9) -- cycle;
		\path (A) [fill=ThemeColor, scale = 0.45, rounded corners = 3] +(6, 0) -- +(6.65,0) -- +(10.05,-6.9) -- +(8.75,-6.9) -- +(6,-1.3) -- +(4.8,-3.7) -- +(7.52,-3.7) -- +(8.85,-4.8) -- +(4.3,-4.8) -- +(3.25,-6.9) -- +(1.95,-6.9) -- +(5.35,0) -- cycle;
