...
\hypersetup{pdftitle={Titel},pdfauthor={Name}} % Fill out to include PDF metadata for the author and title of the book
\date{\today}
...
%	TITLE PAGE
%----------------------------------------------------------------------------------------
\createTikZTitlePage{Elektro- und \\ Informationstechnik}   {{\huge\textbf{Fach\\}}{Skript, Stand \today)}}   {NAME}
...
\noindent {Published by NAME} % Publisher

\noindent {book-website.com} % URL
...
\noindent Das originale Template (the Legrand Orange Book Template) kann hier heruntergeladen werden: http://www.latextemplates.com/template/the-legrand-orange-book 
